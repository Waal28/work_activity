...
<div class="card mb-5 mb-xl-12">
	...
	<div class="card-header border-0 pt-5">
		...
		<div class="card-toolbar">
			<button type="button" class="btn btn-sm tombol-tambah" onclick="handleClickTambahPekerjaan()" data-bs-toggle="modal" data-bs-target="#modalDevelopmentCommitment">
...
<script>
	...
	const form = {
		...
		fields: {
			...
			lh: root.querySelector('[form-field="lh"]'),
