<div class="col-xl-12 mb-10">
	<div class="row g-5 g-xl-10">
			...
			<div id="kt_sliders_widget_1_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5000">
				<div class="card-header pt-5">
					<h4 class="card-title d-flex align-items-start flex-column">
						<span class="card-label fw-bold text-gray-800">Audit Keuangan</span>
					...
					<div class="carousel-inner mt-n5">
						<div class="carousel-item active show">
							<div class="d-flex align-items-center mb-5">
								...
								<div class="m-0">
									<h4 class="fw-bold text-gray-800 mb-3">Andika Syahputra</h4>
		...
		<div class="col-xl-4 mb-5 mb-xl-12">
			<div id="kt_sliders_widget_1_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5000">
				<div class="card-header pt-5">
					<h4 class="card-title d-flex align-items-start flex-column">
						<span class="card-label fw-bold text-gray-800">Backup Data Server</span>
						<span class="text-gray-500 mt-1 fw-bold fs-7">Pekerjaan</span>
					</h4>
					<div class="card-toolbar">
					...
					<div class="carousel-inner mt-n5">
						<div class="carousel-item active show">
							<div class="d-flex align-items-center mb-5">
								...
								<div class="m-0">
									<h4 class="fw-bold text-gray-800 mb-3">Riski Indra</h4>
									<div class="d-flex d-grid gap-5">
										<div class="d-flex flex-column flex-shrink-0 me-4">
											<span class="d-flex align-items-center fs-7 fw-bold mb-2">
												<i class="ki-duotone ki-right-square fs-6 text-gray-600 me-2">
										...
										<div class="d-flex flex-column flex-shrink-0">
											<span class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2">
												10 Februari 2025</span>
											<span class="d-flex align-items-center fw-bold fs-7 text-success">
												Disetujui</span>
										</div>
									</div>
								</div>
							...
							<div class="card-body d-flex align-items-end pt-0">
								<div class="d-flex align-items-center flex-column mt-3 w-100">
									<div class="d-flex justify-content-between w-100 mt-auto mb-2">
										<span class="fw-bolder fs-6 text-gray-900">Progress</span>
										<span class="fw-bold fs-6 text-gray-500">72%</span>
									</div>
		...
		<div class="col-xl-4 mb-5 mb-xl-12">
			<div id="kt_sliders_widget_1_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5000">
				<div class="card-header pt-5">
					<h4 class="card-title d-flex align-items-start flex-column">
						<span class="card-label fw-bold text-gray-800">Pendataan Inventaris</span>
						<span class="text-gray-500 mt-1 fw-bold fs-7">Pekerjaan</span>
					</h4>
					<div class="card-toolbar">
					...
					<div class="carousel-inner mt-n5">
						<div class="carousel-item active show">
							<div class="d-flex align-items-center mb-5">
								...
								<div class="m-0">
									<h4 class="fw-bold text-gray-800 mb-3">Dewi</h4>
									<div class="d-flex d-grid gap-5">
										<div class="d-flex flex-column flex-shrink-0 me-4">
											<span class="d-flex align-items-center fs-7 fw-bold mb-2">
												<i class="ki-duotone ki-right-square fs-6 text-gray-600 me-2">
							...
							<div class="card-body d-flex align-items-end pt-0">
								<div class="d-flex align-items-center flex-column mt-3 w-100">
									<div class="d-flex justify-content-between w-100 mt-auto mb-2">
										<span class="fw-bolder fs-6 text-gray-900">Progress</span>
										<span class="fw-bold fs-6 text-gray-500">50%</span>
									</div>
									<div class="h-8px mx-3 w-100 bg-light-warning rounded">
										<div class="bg-warning rounded h-8px" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
								</div>
							</div>
							<div class="m-0">
							...
							<div class="current" data-kt-stepper-element="content">
								<div class="w-100">
									<div class="fv-row mb-10">
										...
										<textarea class="form-control form-control-solid" rows="3" name="keterangan" placeholder="Keterangan">Melakukan Pemeriksaan Terkait Keuangan</textarea>
									</div>
									<div class="fv-row">
											...
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												<span class="d-flex align-items-center me-2">
													...
													<span class="d-flex flex-column">
														...
														<span class="fs-7 text-muted">Andika Syahputra</span>
													</span>
												</span>
											</label>
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												<span class="d-flex align-items-center me-2">
													...
													<span class="d-flex flex-column">
														...
														<span class="fs-7 text-muted">Masih dikerjakan</span>
													</span>
												</span>
											</label>
											<label class="d-flex flex-stack cursor-pointer">
												<span class="d-flex align-items-center me-2">
													...
													<span class="d-flex flex-column">
														...
														<span class="fs-7 text-muted">10 Februari 2025</span>
													</span>
												</span>
											</label>
										</div>
