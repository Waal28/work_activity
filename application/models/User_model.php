...
class User_model extends CI_Model
{
  ...
  {
    $this->db->select('users.*, unit_level.nm_unit_level, unit_level.id_unit_level, unit_kerja.nm_unit_kerja, unit_kerja.id_unit_kerja, unit_bisnis.nm_unit_bisnis, unit_bisnis.id_unit_bisnis, pegawai.*');
    $this->db->from('users');
